...
(function () {
  var CATALOG = {
    ...
    items: [
      ...
      { id:"mystery", type:"game", code:"SCI 225 · case", title:"Medical Mystery", subtitle:"Clinical Case Mystery", area:"sci", credits:0, status:"live", visitKey:null,
        path:"01_games/19_BIO_MedicalMystery_NC_v3.html",
        topics:"Differential diagnosis · Labs · Imaging · Clinical reasoning", boss:"The Diagnosis",
        note:"Clinical case simulator — does not report cross-game progress." },
